...
const user_constraints_1 = require("./user.constraints");
...
const getAllUsers = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const queryBuilder = new QueryBuilders_1.QueryBuilder(user_model_1.User.find(), query);
    const usersData = queryBuilder
        .filter()
        .search(user_constraints_1.userSearchableFields)
        .sort()
        .fields()
        .paginate();
